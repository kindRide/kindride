...
import { getJourneysRegisterUrlOrNull, getMatchingDemoDriversUrlOrNull } from "@/lib/backend-api-urls";
...
export default function RideRequestScreen() {
  ...
  const [journeyId] = useState(() => createJourneyId());
  ...
  useEffect(() => {
    async function registerJourney() {
      ...
      try {
        ...
        /* offline: passenger should retry from a network; leg complete may fail until registered */
      }
    }
    registerJourney();
  }, [journeyId]);
